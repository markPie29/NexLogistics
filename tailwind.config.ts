  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        glow: "0 0 0 1px rgba(102,178,178,0.4), 0 0 20px rgba(102,178,178,0.25)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 0 0 rgba(102,178,178,0.5)" },
          "50%": { boxShadow: "0 0 0 8px rgba(102,178,178,0)" },
        },
        "pulse-glow-red": {
