                ...
                <table className="w-full min-w-[900px] text-sm">
                  ...
                  <tbody>
                    ...
                    {filteredRoutes.map((route) => (
                      <tr
                        key={route.id}
                        className="border-b border-brand-border/60 dark:border-white/10 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors"
                      >
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-3">
                      {recommendations.map((rec) => (
                        <div
                          key={rec.id}
                          className="flex items-center gap-4 rounded-xl border border-brand-border dark:border-white/10 p-4 hover:bg-gray-50/50 dark:hover:bg-white/5 transition-colors"
                        >
